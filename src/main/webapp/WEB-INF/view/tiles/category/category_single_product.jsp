...
<div class="span3 ${product.category.id}" data-price="${product.price}" data-popularity="4" data-size="m|l" data-color="blue|orange" data-brand="${product.brand.name}">
 <div class="product">
     <div class="product-img">
         <div class="picture">
             <img width="540" height="374" alt="" src="${staticServer}/static/images/dummy/products/product-6.jpg" />
             <div class="img-overlay">
                 <a class="btn more btn-primary" href="/product?productid=${product.id}">More</a>
